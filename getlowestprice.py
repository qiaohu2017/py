...
#更新xpath chrome F12 选中元素，copy xpath 2018.4.13 xpath 第一个是名字 第二个是价格
import codecs
...
func.MAX_TRY_TIMES  = 5
func.TIME_OUT = 10
func.RUN_MODE = 3

currency_RMB = 1   #2018.4.13 rate
currency_EUR = 7.9 # 1 EUR = 7.9 RMB
currency_USD = 6.6  
currency_JPN = 0.06
currency_GBR = 8.8

#test
amz_test = ['http://www.amazon.com/s/url=search-alias%3Daps&field-keywords=',
              currency_USD,    #货币换算rmb   
             [
             '//*[@id="result_0"]/div/div/div/div[2]/div[1]/div[1]/a/h2',           #title
            '//*[@id="result_0"]/div/div/div/div[2]/div[2]/div[1]/div[1]/a/span[2]/span/span' #price .will change
             #other price .will change
...
amz_com = ['http://www.amazon.com/s/url=search-alias%3Daps&field-keywords=',
            ...
            '//*[@id="result_0"]/div/div/div/div[2]/div[2]/div[1]/div[1]/a/span[2]/span/span' #price  if i == 1: #xpath中第一个是价格
            ] 
          ] 
...
z_cn  = [ 'http://www.amazon.cn/s/url=search-alias%3Daps&field-keywords=',
          ...
          '//*[@id="result_0"]/div/div[5]/div[1]/a/span'
          ]  
        ]
          
amz_uk = ['http://www.amazon.co.uk/s/url=search-alias%3Daps&field-keywords=',
            currency_GBR, 
           ['//*[@id="result_0"]/div/div/div/div[2]/div[1]/div[1]/a/h2',     #goods title
           '//*[@id="result_0"]/div/div/div/div[2]/div[2]/div[1]/div[1]/a/span',  # price
           ]
         ]
...
amz_jp = [ 'http://www.amazon.co.jp/s/url=search-alias%3Daps&field-keywords=',
          currency_JPN,
          ['//*[@id="result_0"]/div/div[3]/div[1]/a/h2',
          '//*[@id="result_0"]/div/div[5]/div/a/span[1]']]
...
amz_it = [ 'http://www.amazon.it/s/url=search-alias%3Daps&field-keywords=',
           currency_EUR, 
          ['//*[@id="result_0"]/div/div/div/div[2]/div[1]/div[1]/a/h2',
          '//*[@id="result_0"]/div/div/div/div[2]/div[2]/div[1]/div/a/span']]
          
jd = [ 'http://search.jd.com/Search?keyword=',
          currency_RMB,
          ['//*[@id="J_goodsList"]/ul/li[1]/div/div[3]',
            '//*[@id="J_goodsList"]/ul/li[1]/div/div[2]'
          ]
     ]              
                    
site_list = [ z_cn, amz_com,   amz_de, amz_fr, amz_jp, amz_uk, amz_it]
#site_list = [amz_uk] 
...
def judge_currency(str_price):	#no use
...
def _change_currency(str_price, c): #no use
...
def output ( 	all_result_list ):
	...
	try:
	   all_result_list.sort(key = lambda x:float(x[3][4:]) , reverse = True) 
	except Exception , e:
	...
	for result_list in all_result_list:
 	...
 	print("                    get %d  result !"  % len(all_result_list))
...
if __name__ == '__main__':
	...
	print("currency Rate day: 20180413" )
